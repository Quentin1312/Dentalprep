...
|------|----------------|-------|------|
| `HBFA011` | Gingivectomie d'un secteur de 1 à 3 dents (à confirmer) | 2x ([associations#18] Mme Sophie FONFEC / Dr SALAMI…) | À vérifier — gingivectomie d'un secteur |
| `HBFD032` | Pulpotomie sur dent temporaire (à vérifier — code probablement différent) | 2x ([modificateurs#6] Extraction 1ère molaire temp. sup. droite + pulpotomie 2e molaire temp. sup. droite + restauration 1 face 1ère molaire perm. sup. droite chez enfant 9 ans…) | À vérifier — pulpotomie sur dent temporaire (code probablement différent) |
| `HBGD021` | Avulsion d'une dent temporaire (code à confirmer) | 2x ([procedures#4] Extraction de 14 dents temporaires (incisives, canines, 1ères et 2èmes molaires maxillaires et mandibulaires)…) | À vérifier — avulsion dent temporaire |
| `HBJD003` | Évacuation d'un abcès parodontal (à confirmer) | 1x ([modificateurs#7] Évacuation d'un abcès parodontal sur la 2e molaire inférieure droite hors permanence des soins, le 25/12, après radio diagnostique) | À vérifier — évacuation abcès parodontal |
| `HBLD028` | — | 2x ([devis#2] Mme Anna KONDA / Dr BOA…) | À vérifier — utilisé dans un devis |
| `HBLD031` | Pose d'une couronne dentoportée céramo-métallique (à confirmer) | 7x ([actes_isoles#14] Pose d'une couronne implanto-portée sur la première molaire inférieure droite…) | À vérifier — pose d'une couronne dentoportée (varie selon matériau) |
| `HBLD034` | Application topique de fluorures (à confirmer) | 1x ([actes_isoles#16] Application de vernis fluoré sur les 2 arcades chez un enfant de 7 ans présentant un haut risque carieux) | À vérifier — vernis fluoré, peut être un autre code (HBLD ou HBPD ?) |
| `HBLD035` | Adjonction sur une prothèse amovible (à confirmer) | 2x ([actes_isoles#10] Adjonction de l'incisive centrale inférieure gauche sur une prothèse amovible partielle…) | À vérifier — adjonction sur prothèse amovible |
...
| `HBLD080` | Réparation d'une prothèse amovible en résine fracturée (à confirmer) | 0x | À vérifier — réparation prothèse amovible résine |
| `HBLD090` | Pose d'une couronne dentaire transitoire (à confirmer) | 4x ([cmu_css#2] Pose d'une couronne céramo-métal sur la première molaire supérieure gauche (patient CSS)…) | À vérifier — pose couronne transitoire |
| `HBMD050` | Restauration d'une dent par matériau inséré en phase plastique avec ancrage radiculaire (à confirmer) | 3x ([actes_isoles#18] Restauration par inlay-onlay 2 faces en céramique sur la deuxième molaire inférieure gauche…) | DOUTEUX — j'utilise ce code pour 'inlay-onlay' et 'restauration avec ancrage radiculaire'. À vérifier |
...
| `HBLD074` | Pose d'une infrastructure coronoradiculaire coulée (inlay-core) | 4x ([cmu_css#2] Pose d'une couronne céramo-métal sur la première molaire supérieure gauche (patient CSS)…) |  |
